    ...
    >
      ...
      >
        ...
        <div class="block lg:hidden">
          <button sm:v-hammer:tap="toggle" @click="toggle" class="px-3 py-2 border rounded border-gray-500 hover:text-gray-600 hover:border-gray-600">
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center">
          ...
          <li class="mr-8">
            <a href="https://github.com/iancleary" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li class="mr-8">
            <a href="https://twitter.com/icancclearynow" target="_blank" class="text-white hover:text-gray-400">
